...
#pragma omp parallel num_threads(num_threads)

	{
		...
		#pragma omp single 
		{
			...
			b = (world_rank == 0)?20 : 30 ; 

			#pragma omp task depend(in : b) depend(out : a)

			{
				MPI_Sendrecv(&b , 1 , MPI_INT , buddy , 0 , &a , 1 , MPI_INT , world_rank , 0, MPI_COMM_WORLD , MPI_STATUS_IGNORE);
			}
